...
const TransactionErrorResult = superstruct.nullable(superstruct.type({}));
/**
...
class Connection {
  ...
  constructor(endpoint, commitment) {
    ...
    this._rpcClient = createRpcClient(url$1.href, useHttps);
  ...
  async getConfirmedSignaturesForAddress(address, startSlot, endSlot) {
    ...
    const res = superstruct.create(unsafeRes, GetConfirmedSignaturesForAddressRpcResult);
...
exports.GetConfirmedBlockRpcResult = GetConfirmedBlockRpcResult;
